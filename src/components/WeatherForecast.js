...
const WeatherForecast = () => {
  ...
  const apiKey = 'c1fa1bc7bb0171d42b1ebac7deacb289'; // Add single or double quotes around the API key
    ...
    <div>
      <div>
        <div className="weather-today">
          <h2>
            <span className="weather-icon" style={{ fontSize: 100 }}>
              {getWeatherIcon(main)}
            </span>{' '}
            Boston Current Temperature: {currentTemp}°C
          </h2>
        </div>
